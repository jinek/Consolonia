...
{
    public new void Move(IInputElement element, NavigationDirection direction, KeyModifiers keyModifiers = KeyModifiers.None)
    {
            ...
            NavigationDirection.Up)
        {
            ...
            (Point p1, Point p2) = GetOriginalPoint(element.TransformedBounds.Value.Clip);
            ...
            var focusableElements = visualRoot.GetVisualDescendants()
                ...
                .Select(inputElement =>
                {
                    (Point firstTargetPoint, Point secondTargetPoint) =
                        GetTargetPoint(inputElement.TransformedBounds.Value.Clip);
                    return new
                    {
                        vector =
                            firstTargetPoint / 2 +
