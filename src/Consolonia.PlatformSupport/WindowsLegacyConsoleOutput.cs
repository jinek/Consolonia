...
namespace Consolonia.PlatformSupport
{
    internal class WindowsLegacyConsoleOutput : IConsoleOutput
    {
        ...
        public bool CaretVisible
        {
            get
            {
                if (!GetConsoleCursorInfo(_consoleBuffer.BufferHandle, out CONSOLE_CURSOR_INFO info))
            ...
            FontWeight? weight, TextDecorationLocation? textDecoration, string str)
        {
            ...
            (object b, object f) = consoleColorMode.MapColors(background, foreground, weight);
            ...
            CHARACTER_ATTRIBUTE backgroundAttributes = backgroundConsoleColor switch
            {
                ...
                ConsoleColor.DarkGray => CHARACTER_ATTRIBUTE.BACKGROUND_RED | CHARACTER_ATTRIBUTE.BACKGROUND_GREEN |
                                         CHARACTER_ATTRIBUTE.BACKGROUND_BLUE,
                ConsoleColor.Gray => CHARACTER_ATTRIBUTE.BACKGROUND_RED | CHARACTER_ATTRIBUTE.BACKGROUND_GREEN |
                                     CHARACTER_ATTRIBUTE.BACKGROUND_BLUE | CHARACTER_ATTRIBUTE.BACKGROUND_INTENSITY,
                ...
                ConsoleColor.Yellow => CHARACTER_ATTRIBUTE.BACKGROUND_RED | CHARACTER_ATTRIBUTE.BACKGROUND_GREEN |
                                       CHARACTER_ATTRIBUTE.BACKGROUND_INTENSITY,
                ConsoleColor.Magenta => CHARACTER_ATTRIBUTE.BACKGROUND_RED | CHARACTER_ATTRIBUTE.BACKGROUND_BLUE |
                                        CHARACTER_ATTRIBUTE.BACKGROUND_INTENSITY,
                ConsoleColor.Cyan => CHARACTER_ATTRIBUTE.BACKGROUND_GREEN | CHARACTER_ATTRIBUTE.BACKGROUND_BLUE |
                                     CHARACTER_ATTRIBUTE.BACKGROUND_INTENSITY,
                ConsoleColor.White => CHARACTER_ATTRIBUTE.BACKGROUND_RED | CHARACTER_ATTRIBUTE.BACKGROUND_GREEN |
                                      CHARACTER_ATTRIBUTE.BACKGROUND_BLUE | CHARACTER_ATTRIBUTE.BACKGROUND_INTENSITY,
            ...
            CHARACTER_ATTRIBUTE foregroundAttributes = foregroundConsoleColor switch
            {
                ...
                ConsoleColor.DarkGray => CHARACTER_ATTRIBUTE.FOREGROUND_RED | CHARACTER_ATTRIBUTE.FOREGROUND_GREEN |
                                         CHARACTER_ATTRIBUTE.FOREGROUND_BLUE,
                ConsoleColor.Gray => CHARACTER_ATTRIBUTE.FOREGROUND_RED | CHARACTER_ATTRIBUTE.FOREGROUND_GREEN |
                                     CHARACTER_ATTRIBUTE.FOREGROUND_BLUE | CHARACTER_ATTRIBUTE.FOREGROUND_INTENSITY,
                ...
                ConsoleColor.Yellow => CHARACTER_ATTRIBUTE.FOREGROUND_RED | CHARACTER_ATTRIBUTE.FOREGROUND_GREEN |
                                       CHARACTER_ATTRIBUTE.FOREGROUND_INTENSITY,
                ConsoleColor.Magenta => CHARACTER_ATTRIBUTE.FOREGROUND_RED | CHARACTER_ATTRIBUTE.FOREGROUND_BLUE |
                                        CHARACTER_ATTRIBUTE.FOREGROUND_INTENSITY,
                ConsoleColor.Cyan => CHARACTER_ATTRIBUTE.FOREGROUND_GREEN | CHARACTER_ATTRIBUTE.FOREGROUND_BLUE |
                                     CHARACTER_ATTRIBUTE.FOREGROUND_INTENSITY,
                ConsoleColor.White => CHARACTER_ATTRIBUTE.FOREGROUND_RED | CHARACTER_ATTRIBUTE.FOREGROUND_GREEN |
                                      CHARACTER_ATTRIBUTE.FOREGROUND_BLUE | CHARACTER_ATTRIBUTE.FOREGROUND_INTENSITY,
                _ => throw new ArgumentOutOfRangeException(nameof(foreground))
            };
            CHARACTER_ATTRIBUTE attributes = foregroundAttributes | backgroundAttributes;
            if (textDecoration == TextDecorationLocation.Underline)
                attributes |= CHARACTER_ATTRIBUTE.COMMON_LVB_UNDERSCORE;

            _consoleBuffer.DrawString(str, (short)bufferPoint.X, (short)bufferPoint.Y, attributes);
        }
