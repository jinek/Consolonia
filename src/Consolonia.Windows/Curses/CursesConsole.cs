...
namespace Consolonia.Windows.Curses
{
    public class CursesConsole : InputLessDefaultNetConsole
    {
        ...
        {
            int wch;
            var code = Unix.Terminal.Curses.get_wch(out wch);
        ...
        private void HandleMouseInput(Unix.Terminal.Curses.MouseEvent ev)
        {
            ...
            RawPointerEventType rawPointerEventType = MouseEventFlagTranslator.Translate(ev.ButtonState);
            if (rawPointerEventType == default) return;
